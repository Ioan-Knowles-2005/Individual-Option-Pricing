...
with col1:
    ...
    S = st.number_input("Current Stock Price: ", min_value=float(0),value=100, step=0.01, key="S_input")
    K = st.number_input("Strike Price: ", min_value=float(0), value=100, step=0.01, key="K_input")
