...
with col1:
    ...
    S = st.number_input("Current Stock Price: ", min_value=float(0), step=0.01,value=100, key="S_input")
    K = st.number_input("Strike Price: ", min_value=float(0), step=0.01, value=100, key="K_input")
